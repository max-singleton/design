...
if ($arIBlock = $rsIBlock->GetNext()) {
	$strAllElements = GetMessage("T_NEWS_ALL") . " " . ToLower($arIBlock['ELEMENTS_NAME']);
} else {
	$strAllElements = GetMessage("T_NEWS_ALL_ELEMENTS");
}
?>
<p><a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=$strAllElements?></a></p>
