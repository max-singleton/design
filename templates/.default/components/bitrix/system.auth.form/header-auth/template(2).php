...
<div class="window__info">Уважаемые пользователи, для входа на наш новый сайт достояние-наследие.рф логин и пароль с сайта etker21.ru не подходит. Для удобного пользования возможностями сайта и личным кабинетом вам необходимо заново пройти регистрацию на сайте.
				</div>
			...
			<div class="window__info">
				...
				<a class="window-close window__info-link" onclick='$("#contact-user-name").focus()' href="#contact"></a>
			</div>
		</div>
