    ...
    <? if ($arResult["CURRENT_PAGE"] != 'history') : ?>
        <div class="table1 meters__table">
            ...
            <div class="table1__row">
                    ...
                    <div class="table1">
                        ...
                        <div class="table1__row">
                            <div class="table1__cell meters__data">
                                ...
                                <?endif;?>
                                <div><?=FloatVal($arItem['PREV_VALUE']['VALUE'.$i])." ".$arItem["UNIT"]?></div>
                            </div>
                            <div class="table1__cell">
                                <?if($arItem['VALUES_COUNT']>1):?>
                                    <div class="color-main"><?= GetMessage("CTM_TARIFF_N",array("#N#"=>$i))?></div>
                ...
                <div class="table1__cell meters__theme-title padding-default">
                    <a class="color-main" href="<?= $arResult["HISTORY_URL"] ?>&id=<?= $arItem["ID"] ?>"><?= GetMessage("CTM_LOOK")?><span class="visible-mobi"><?= GetMessage("CTM_HISTORY_AND_EXPENSE")?></span></a>
                </div>
            </div>
            <?endforeach;
            }?>
