	...
	<div id="SignupForm">
		...
		<fieldset>
			...
			<div style="text-align: left">
				<input type="radio" name="radio" value="bycode" id="bycode" class="radio" required>
				<label for="bycode">
					<span class="title"><?=GetMessage("TSZH_CON_REGCODE")?></span>
				</label>
				<div class="subscribe">
					<?=GetMessage("TSZH_CON_REGCODE_DESC")?>
				</div>
				<input type="radio" name="radio" value="bypass" id="bypass" class="radio" required>
				<label for="bypass">
					<span class="title"><?=GetMessage("TSZH_CON_PASS")?></span>
				</label>
				<div class="subscribe">
					<?=GetMessage("TSZH_CON_PASS_DESC")?>
				</div>
